package com.rightside.e_agenda.natividadeView.farmacia;
...
public class FarmaciaNatActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_farmacia_natividade);
        //TOOLBAR
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_volteascidades) {
            AlertDialog.Builder alerta = new AlertDialog.Builder(FarmaciaNatActivity.this);
            ...
            alerta  .setIcon(R.drawable.ic_aviso)
                    ...
                    .setPositiveButton("Sim", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int id) {
                            Intent chamatela = new Intent(FarmaciaNatActivity.this,CidadeActivity.class);
        ...
        if (id == R.id.action_add) {
            ...
            alerta  .setIcon(R.drawable.ic_aviso)
                    ...
                    .setPositiveButton("Sim", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int id) {
                            Intent chamatela = new Intent(FarmaciaNatActivity.this,CadastroLanchoneteNatActivity.class);
                            startActivity(chamatela);
                        }
                    });
